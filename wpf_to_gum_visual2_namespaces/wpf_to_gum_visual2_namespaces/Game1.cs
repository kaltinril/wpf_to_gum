...
namespace wpf_to_gum
{
    public class Game1 : Game
    {
        ...
        private void TextBlockWPFConverted(StackPanel panelToAddTo)
        {
            ...
            ColoredRectangleInstance.HeightUnits = DimensionUnitType.RelativeToParent;
            ColoredRectangleInstance.Width = 0f;
            ColoredRectangleInstance.WidthUnits = DimensionUnitType.RelativeToParent;
            ...
            ColoredRectangleInstance1.HeightUnits = DimensionUnitType.RelativeToParent;
            ColoredRectangleInstance1.Width = -20f;
            ColoredRectangleInstance1.WidthUnits = DimensionUnitType.RelativeToParent;
            ColoredRectangleInstance1.X = 0f;
            ColoredRectangleInstance1.XOrigin = HorizontalAlignment.Center;
            ColoredRectangleInstance1.XUnits = GeneralUnitType.PixelsFromMiddle;
            ColoredRectangleInstance1.Y = 0f;
            ColoredRectangleInstance1.YOrigin = VerticalAlignment.Center;
            ColoredRectangleInstance1.YUnits = GeneralUnitType.PixelsFromMiddle;
        ...
        private class ItemWithButton : FrameworkElement
        {
            ...
            {
                this.Visual = new ContainerRuntime();
